...
class DataAugmentation(nn.Module):
    ...
    def __init__(self, selfAug, params) -> None:
        super(DataAugmentation, self).__init__()

        self.transforms = nn.Sequential()
        for name, value in params.items():
            self.transforms.add_module(name, selfAug.operator(name).func(same_on_batch = True, **value))
...
class AugSeq:
    ...
    def compose(self, 
        ...
        return DataAugmentation(self, self.get_parameters_value())(data)
    ...
    def init(self, 
        ...
        var = "DATASET_SIZE : {}, TOTAL_EPOCHS: {}, BATCH_SIZE : {}, LAMDA : {}, OMEGA : {}"
        print ("Augs Initiated with", end = "\n")
    ...
    def __max_prob(self)->List[str]:
        ...
        highest probability
        """
        # print ([(name, type(value.probability)) for name, value in self.__augList.items()])
